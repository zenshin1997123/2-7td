...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: 'bold', color: '#fbbf24' },
  newGameButton: { backgroundColor: '#ffd700', paddingVertical: 8, paddingHorizontal: 14, borderRadius: 16 },
  newGameText: { color: '#000', fontWeight: 'bold', fontSize: 15 },
  loadingText: { color: '#fff', fontSize: 18, textAlign: 'center', marginTop: 50 },
  infoText: { color: '#fff', fontSize: 16, marginHorizontal: 10, marginTop: 6 },
  winnerBanner: {
    marginHorizontal: 10,
    marginTop: 8,
    marginBottom: 4,
  ...
  winnerText: { color: '#ffd700', fontSize: 16, fontWeight: 'bold' },
  tableWrap: {
    flex: 1,
  ...
  centerPotLabel: { color: '#e5e7eb', fontSize: 15 },
  centerPotAmount: { color: '#fff', fontSize: 36, fontWeight: 'bold' },
  centerPotSub: { color: '#cbd5e1', fontSize: 14 },
  seat: {
    position: 'absolute',
    width: 200,
    minHeight: 85,
  ...
  activeSeat: { borderColor: '#22d3ee', borderWidth: 3 },
  seatTop: { top: 10, left: '50%', marginLeft: -100 },
  seatTopLeft: { top: 70, left: 20 },
  seatTopRight: { top: 70, right: 20 },
  seatBottomLeft: { bottom: 36, left: 20 },
  seatBottomRight: { bottom: 36, right: 20 },
  seatName: { color: '#fef3c7', fontWeight: 'bold', fontSize: 16 },
  seatMeta: { color: '#d1d5db', fontSize: 14, marginBottom: 3 },
  seatCards: { color: '#e5e7eb', fontSize: 16 },
  playerArea: {
    marginTop: 6,
    alignItems: 'center',
  ...
  playerText: { color: '#ffd700', fontSize: 18, fontWeight: 'bold' },
  controls: {
    borderTopWidth: 1,
